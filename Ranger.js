...
const CONFIG = {
	combat: {
		...
		focusFire: { enabled: true, preferSingleTarget: true, leaderPicksLowestHp: true },
...
const handleAttack = async () => {
	...
	if (ff.enabled !== false && (ff.preferSingleTarget || crowded)) {
